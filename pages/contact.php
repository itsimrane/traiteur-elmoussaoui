...
<head>
  ...
  <meta name="description"
    content="Contactez Traiteur EL MOUSSAOUI pour organiser votre événement à Errachidia. Devis gratuit, réponse rapide.">
...
<body>
  ...
  <div class="page-hero">
    <div class="container">
      <span class="section-tag" data-aos="fade-down" data-fr="Parlons de votre projet"
        data-ar="لنتحدث عن مشروعك">Parlons de votre projet</span>
      ...
      <div class="contact-layout">
        ...
        <div>
          <div class="contact-info-card" data-aos="fade-right">
            ...
            <div class="contact-info-sub" data-fr="Disponibles 7j/7 pour répondre à vos questions."
              data-ar="متاحون 7 أيام/7 للإجابة على أسئلتكم.">Disponibles 7j/7 pour répondre à vos questions.</div>
            ...
            <div class="contact-item">
              ...
              <div class="contact-item-body">
                ...
                <span data-fr="Lun–Sam : 8h–20h | Dim : 9h–17h" data-ar="الإثنين–السبت: 8ص–8م | الأحد: 9ص–5م">Lun–Sam :
                  8h–20h | Dim : 9h–17h</span>
              </div>
            </div>
            ...
            <label
              style="font-size:.68rem;color:var(--text-muted);text-transform:uppercase;letter-spacing:.5px;display:block;margin-bottom:10px"
              data-fr="Suivez-nous" data-ar="تابعونا">Suivez-nous</label>
            <div class="social-row">
              <a href="https://www.facebook.com/profile.php?id=61565592029636" class="social-btn" title="Facebook"
                target="_blank" rel="noopener"><i class="fab fa-facebook-f"></i></a>
              <a href="https://www.instagram.com/elmoussaoui_traiteur__officiel/" class="social-btn" title="Instagram"
                target="_blank" rel="noopener"><i class="fab fa-instagram"></i></a>
              <a href="https://wa.me/212626986533" class="social-btn" title="WhatsApp" target="_blank" rel="noopener"
                style="border-color:rgba(37,211,102,.3);color:#25D366"><i class="fab fa-whatsapp"></i></a>
            </div>

            <!-- Google Maps Errachidia -->
            <iframe class="map-frame"
              src="https://maps.google.com/maps?q=Errachidia,Maroc&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0"
        ...
        <div class="contact-form-card" data-aos="fade-left">
          <div class="form-title" data-fr="Envoyez-nous un message" data-ar="أرسل لنا رسالة">Envoyez-nous un message
          </div>
          <div class="form-sub" data-fr="Réponse garantie sous 24h. Pour les urgences, appelez le 0626 986 533."
            data-ar="رد مضمون خلال 24 ساعة. للطوارئ، اتصل على 0626 986 533.">Réponse garantie sous 24h. Pour les
            urgences, appelez le 0626 986 533.</div>

          <?php if ($success): ?>
            <div class="alert-success">
              <i class="fas fa-check-circle"></i>
              <span data-fr="Votre message a été envoyé ! Nous vous répondrons dans les 24h."
                data-ar="تم إرسال رسالتك! سنرد عليك خلال 24 ساعة.">Votre message a été envoyé ! Nous vous répondrons dans
                les 24h.</span>
            </div>
          <?php elseif ($error): ?>
          ...
          <form method="POST" action="contact.php" id="contactForm">
            <div class="form-row-2">
              <div class="form-group">
                ...
                <input type="text" name="prenom" class="form-control" required
                  value="<?= htmlspecialchars($_POST['prenom'] ?? '') ?>" data-fr-placeholder="Votre prénom"
                  data-ar-placeholder="اسمك الأول" placeholder="Votre prénom">
              </div>
              <div class="form-group">
                <label data-fr="Nom" data-ar="الاسم العائلي">Nom <span>*</span></label>
                <input type="text" name="nom" class="form-control" required
                  value="<?= htmlspecialchars($_POST['nom'] ?? '') ?>" data-fr-placeholder="Votre nom"
                  data-ar-placeholder="اسمك العائلي" placeholder="Votre nom">
              </div>
            </div>
            ...
            <div class="form-row-2">
              <div class="form-group">
                ...
                <input type="email" name="email" class="form-control" required
                  value="<?= htmlspecialchars($_POST['email'] ?? '') ?>" data-fr-placeholder="votre@email.com"
                  data-ar-placeholder="بريدك@الإلكتروني.com" placeholder="votre@email.com">
              </div>
              <div class="form-group">
                <label data-fr="Téléphone" data-ar="رقم الهاتف">Téléphone</label>
                <input type="tel" name="telephone" class="form-control" dir="ltr"
                  value="<?= htmlspecialchars($_POST['telephone'] ?? '') ?>" placeholder="0626 986 533">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <select name="sujet" class="form-control">
                ...
                <option value="Demande de devis" data-fr="Demande de devis" data-ar="طلب عرض أسعار">Demande de devis
                </option>
                <option value="Mariage" data-fr="Organisation mariage" data-ar="تنظيم حفل زفاف">Organisation mariage
                </option>
                <option value="Événement professionnel" data-fr="Événement professionnel" data-ar="حدث مهني">Événement
            ...
            <div class="form-group">
              ...
              <textarea name="message" class="form-control" rows="5" required id="msgArea"
                ...
                oninput="updateCount()"><?= htmlspecialchars($_POST['message'] ?? '') ?></textarea>
            ...
            <p style="font-size:.72rem;color:#555;text-align:center;margin-top:12px"
              ...
              Ou contactez-nous directement sur <a href="https://wa.me/212626986533" target="_blank"
  ...
  <section class="section-cta">
    ...
    <div class="container">
      <div class="cta-content" data-aos="zoom-in">
        <h2 data-fr="Prêt à organiser votre<br>événement avec nous ?" data-ar="هل أنت مستعد لتنظيم<br>مناسبتك معنا؟"
          data-html>Prêt à organiser votre<br>événement avec nous ?</h2>
