...
// Lien WhatsApp propre (sans le +, comme attendu par wa.me)
$waNumero = ltrim(preg_replace('/[^0-9]/', '', $params['contact_whatsapp']), '+');
$telAffiche = preg_replace('/(\d{2})(?=\d)/', '$1 ', $params['contact_telephone']);
        ...
        <div class="contact-info-card" data-aos="fade-right">
          ...
          <div class="contact-item">
            ...
            <div class="contact-item-body">
              ...
              <a href="https://wa.me/<?= htmlspecialchars($waNumero) ?>" target="_blank" dir="ltr"><?= htmlspecialchars($telAffiche) ?></a>
            </div>
          </div>
          ...
          <div class="contact-item">
            ...
            <div class="contact-item-body">
              ...
              <span><?= htmlspecialchars($params['contact_adresse']) ?></span>
            </div>
          </div>
          ...
          <div class="contact-item">
            ...
            <div class="contact-item-body">
              ...
              <span><?= htmlspecialchars($params['horaires_ouverture']) ?></span>
            </div>
          </div>
          ...
          <iframe class="map-frame"
            src="https://maps.google.com/maps?q=<?= htmlspecialchars($params['contact_maps_lat']) ?>,<?= htmlspecialchars($params['contact_maps_lng']) ?>&t=&z=14&ie=UTF8&iwloc=&output=embed"
      ...
      <div class="contact-form-card" data-aos="fade-left">
        ...
        <form method="POST" action="contact.php" id="contactForm">
          ...
          <p style="font-size:.72rem;color:#555;text-align:center;margin-top:12px"
            ...
            Ou contactez-nous directement sur <a href="https://wa.me/<?= htmlspecialchars($waNumero) ?>" target="_blank" style="color:#25D366">WhatsApp</a>.
          </p>
        </form>
      </div>
  ...
  <div class="container">
    <div class="cta-content" data-aos="zoom-in">
      ...
      <div class="cta-actions">
        ...
        <a href="https://wa.me/<?= htmlspecialchars($waNumero) ?>" target="_blank" class="btn-whatsapp large">
...
<a href="https://wa.me/<?= htmlspecialchars($waNumero) ?>" class="whatsapp-float" target="_blank"><i class="fab fa-whatsapp"></i></a>
