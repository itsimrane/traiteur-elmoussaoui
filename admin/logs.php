...
try {
  $resas = $pdo->query("
        SELECT r.id, CONCAT(COALESCE(c.prenom,''), ' ', COALESCE(c.nom,'')) as nom,
               te.nom AS type_evenement, r.statut, r.created_at
        FROM reservations r
  ...
  foreach ($resas as $r) {
    $activites[] = [
      ...
      'titre' => 'Réservation ' . ($r['statut'] === 'accepte' ? 'confirmée' : 'reçue'),
      ...
      <div class="admin-content">
        ...
        <div style="margin-bottom:20px">
          ...
          <div class="today-stats">
            <div class="info-card">
              <div class="info-icon" style="background:rgba(251,183,36,.1);color:#FBB724"><i
            ...
            <div class="info-card">
              <div class="info-icon" style="background:rgba(59,130,246,.1);color:#60A5FA"><i
            ...
            <div class="info-card">
              <div class="info-icon" style="background:rgba(37,211,102,.1);color:#25D366"><i class="fas fa-users"></i>
              </div>
              <div>
        ...
        <!-- Info système -->
        <div
          style="margin-top:24px;background:var(--dark-card);border:1px solid var(--border);border-radius:var(--radius);padding:20px">
          <div
