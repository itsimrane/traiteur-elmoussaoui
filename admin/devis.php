  ...
  <aside class="sidebar" id="sidebar">
    ...
    <div class="sidebar-footer">
      <div style="display:flex;align-items:center;gap:10px;padding:8px;border-radius:10px;background:var(--dark-3)">
        ...
        <a href="logout.php" title="Déconnexion" style="color:var(--text-muted);font-size:.85rem;padding:4px;border-radius:6px;transition:var(--transition)" onmouseover="this.style.color='var(--gold)'" onmouseout="this.style.color='var(--text-muted)'">
    ...
    <div class="admin-content">
      ...
      <div class="nouveau-devis-card" id="newDevisForm">
        ...
        <form method="POST" action="api/save_devis.php">
          ...
          <div class="form-group" style="margin-bottom:16px">
            ...
            <textarea name="message" class="form-control" rows="3" placeholder="Détails supplémentaires..."></textarea>
          </div>
      ...
      <div class="devis-table-wrap">
        <div class="devis-table-header">
          <h3><i class="fas fa-list" style="color:var(--gold);margin-right:8px"></i>Liste des devis (<?= $total ?>)</h3>
          <div style="display:flex;gap:10px;align-items:center;flex-wrap:wrap">
            <input type="text" class="search-input" id="searchDevis" placeholder="\ud83d\udd0d Rechercher..." oninput="filterDevis()">
            <div class="table-filters">
              <button class="tfilter active" onclick="filterStatut('all',this)">Tous</button>
              <button class="tfilter" onclick="filterStatut('en_attente',this)">En attente</button>
              <button class="tfilter" onclick="filterStatut('confirme',this)">Confirmés</button>
