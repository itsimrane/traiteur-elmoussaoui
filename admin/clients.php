...
<head>
  ...
  <style>
    ...
    /* Table */
    .clients-table-wrap { background:var(--dark-card); border:1px solid var(--border); border-radius:var(--radius); overflow:hidden; }
    ...
    .search-input { background:var(--dark-3); border:1px solid var(--border); border-radius:8px; padding:8px 14px; color:var(--white); font-size:.82rem; outline:none; width:240px; }
    ...
    .client-avatar { width:36px; height:36px; border-radius:10px; background:linear-gradient(135deg,var(--gold-dark),var(--gold)); display:flex; align-items:center; justify-content:center; font-weight:700; font-size:.85rem; color:var(--dark); flex-shrink:0; }
    .client-info strong { display:block; color:var(--white); font-size:.85rem; }
    .client-info span { font-size:.73rem; color:#555; }
    .source-badge { display:inline-flex; align-items:center; gap:5px; padding:3px 10px; border-radius:20px; font-size:.7rem; background:var(--dark-3); }
    ...
    /* Fiche client */
    .fiche-header { display:flex; align-items:center; gap:16px; padding:20px 22px; border-bottom:1px solid var(--border); background:linear-gradient(135deg,rgba(212,175,55,.06),transparent); }
    .fiche-avatar { width:56px; height:56px; border-radius:14px; background:linear-gradient(135deg,var(--gold-dark),var(--gold)); display:flex; align-items:center; justify-content:center; font-size:1.4rem; font-weight:700; color:var(--dark); flex-shrink:0; }
    .fiche-name { font-size:1.1rem; font-weight:700; color:var(--white); }
    .fiche-sub { font-size:.78rem; color:var(--text-muted); margin-top:3px; }
    ...
    .notes-box { background:var(--dark-3); border-radius:8px; padding:12px 14px; font-size:.82rem; color:var(--text-muted); line-height:1.6; }
    .section-label { font-size:.68rem; color:var(--text-muted); text-transform:uppercase; letter-spacing:.5px; margin:16px 0 10px; font-weight:700; }
  </style>
</head>
<body>
      ...
      <div class="clients-table-wrap">
        ...
        <table id="clientsTable">
          ...
          <tbody>
            ...
            ?>
            <tr data-search="<?= strtolower($nomComplet . ' ' . $c['email'] . ' ' . $c['telephone'] . ' ' . $c['ville']) ?>"
              ...
              <td style="text-align:center">
                ...
                <span style="background:rgba(37,211,102,.1);color:#25D366;padding:3px 10px;border-radius:20px;font-size:.75rem;font-weight:700">
  ...
  <div class="modal-box">
    ...
    <form method="POST" action="clients.php">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn-primary"><i class="fas fa-save"></i> <span id="saveBtnText">Ajouter</span></button>
      </div>
    </form>
  </div>
</div>
